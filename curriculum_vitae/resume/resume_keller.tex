...
\usepackage[a4paper, top = .3in, bottom = .25in, left = .5in, right = .5in]{geometry}
...
\cventry{Spring 2019 -- Present}{Temporary Research Technician}{Alaska Center for Energy and Power, University of Alaska Fairbanks}{Fairbanks, Alaska, USA}{}{
...
\subsection{Accepted w/ Minor Revisions}

\cvitem{}{\small\underline{D. Keller}, D. R. Eagan, G. J. Fochesatto, R. Peterson. “Advantages of Fiber Bragg Gratings over Resistance-Based Strain Gauges in the Presence of Electromagnetic Interference Emitted from an Electric Motor for Aerospace Application.”}

\subsection{In Progress}

\cvitem{}{\small\underline{D. Keller}, G. J. Fochesatto. “A New Wavelet to Determine the Planetary Boundary Layer Height from MPLNET Lidar Backscatter.”}
